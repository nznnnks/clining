      ...
      <nav className="admin-nav">
        <div className="admin-nav__container">
          ...
          <div className="admin-nav__menu">
            <Link 
              to="/admin" 
              className={`admin-nav__item ${isActive('/admin') && !isActive('/admin/portfolio') && !isActive('/admin/promotions') && !isActive('/admin/calculator') && !isActive('/admin/orders') && !isActive('/admin/users') ? 'admin-nav__item--active' : ''}`}
            >
              Home
            </Link>
            <Link 
            ...
            <Link 
              to="/admin/users" 
              className={`admin-nav__item ${isActive('/admin/users') ? 'admin-nav__item--active' : ''}`}
            >
              Пользователи
            </Link>
